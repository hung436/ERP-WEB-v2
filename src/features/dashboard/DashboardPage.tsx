  ...
  return <div className="dashboard-page">
    ...
    <div className="dashboard-focus">
      <section className="surface-panel dashboard-tasks" aria-labelledby="dashboard-tasks-title">
        <div className="section-heading"><div><div><h2 id="dashboard-tasks-title">Công việc cần xử lý</h2></div><span className="section-count">{tasks.length}</span></div><Link aria-label="Xem tất cả công việc" to="/tasks">Xem tất cả</Link></div>
      ...
      <aside className="dashboard-widgets" aria-label="Cập nhật trong ngày">
        <section className="surface-panel compact-widget agenda-widget">
          <div className="widget-heading"><div><span className="section-icon meetings"><ModuleIcon module="meetings" /></span><span><h2>Họp trực tuyến</h2><p>{events.length} cuộc họp hôm nay</p></span></div><Link aria-label="Xem tất cả họp trực tuyến" to="/calendar">Xem tất cả</Link></div>
        ...
        <section className="surface-panel compact-widget announcement-widget">
          <div className="widget-heading"><div><span className="section-icon announcements"><ModuleIcon module="announcements" /></span><span><h2>Thông báo cơ quan</h2><p>Mới từ cơ quan</p></span></div><Link aria-label="Xem tất cả thông báo cơ quan" to="/announcements">Xem tất cả</Link></div>
        ...
        <section className="surface-panel compact-widget chat-widget">
          <div className="widget-heading"><div><span className="section-icon chat"><ModuleIcon module="chat" /></span><span><h2>Tin nhắn mới</h2><p>{summary.unreadChatCount} chưa đọc</p></span></div><Link aria-label="Xem tất cả Chat" to="/chat">Xem tất cả</Link></div>
        ...
        <section className="surface-panel compact-widget mail-widget">
          <div className="widget-heading"><div><span className="section-icon mail"><ModuleIcon module="mail" /></span><span><h2>Mail chưa đọc</h2><p>{summary.unreadMailCount} thư cần xem</p></span></div><Link aria-label="Xem tất cả Mail" to="/mail">Xem tất cả</Link></div>
