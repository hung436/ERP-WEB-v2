...
export function MailQuickView({ mail, onClose }: { mail: MailItem; onClose: () => void }) {
  ...
  return <Modal centered className="dashboard-preview workspace-preview mail-preview-modal" footer={null} onCancel={onClose} open title={<span className="preview-title"><span className="section-icon mail"><ModuleIcon module="mail" size={20} /></span><span>Đọc và trả lời Mail</span><small>· {currentMail.subject}</small></span>} width={760}>
