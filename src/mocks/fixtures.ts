...
const getOffsetDateTime = (days: number, time: string) => {
  const d = new Date();
...
export const meetingEvents: MeetingEvent[] = [
  { id:'event-01', title:'Họp giao ban Ban Nội dung', startAt:getOffsetDateTime(0, '08:30'), endAt:getOffsetDateTime(0, '09:30'), location:'meeting.tuoitre.vn', meetingUrl:'https://meeting.tuoitre.vn/giao-ban-noi-dung', type:'meeting', organizer:'Trần Thu Hà', responseStatus:'accepted', meetingId:'TT-482-193', platform:'meeting.tuoitre.vn', agenda:'Cập nhật tiến độ tuyến bài, kế hoạch xuất bản và các công việc cần phối hợp trong tuần.', participants:['Trần Thu Hà','Nguyễn Minh Anh','Lê Thanh Vân','Nguyễn Hoài Nam'], recordingAvailable:true },
  { id:'event-02', title:'Trao đổi tuyến bài chuyển đổi số', startAt:getOffsetDateTime(0, '10:00'), endAt:getOffsetDateTime(0, '11:00'), location:'meeting.tuoitre.vn', meetingUrl:'https://meeting.tuoitre.vn/chuyen-doi-so', type:'meeting', organizer:'Nguyễn Hoài Nam', responseStatus:'pending', meetingId:'TT-610-245', platform:'meeting.tuoitre.vn', agenda:'Thống nhất góc tiếp cận và phân công nguồn tin cho tuyến bài chuyển đổi số.', participants:['Nguyễn Hoài Nam','Nguyễn Minh Anh','Đỗ Quang Huy'] },
  { id:'event-03', title:'Họp duyệt kế hoạch nội dung tuần 33', startAt:getOffsetDateTime(0, '15:00'), endAt:getOffsetDateTime(0, '16:00'), location:'meeting.tuoitre.vn', meetingUrl:'https://meeting.tuoitre.vn/duyet-noi-dung-33', type:'meeting', organizer:'Ban Thư ký', responseStatus:'pending', meetingId:'TT-775-024', platform:'meeting.tuoitre.vn', agenda:'Duyệt kế hoạch nội dung và nguồn lực sản xuất cho tuần 33.', participants:['Hoàng Tuấn Anh','Trần Thu Hà','Nguyễn Minh Anh'] },
  { id:'event-04', title:'Họp kế hoạch truyền thông tháng 8', startAt:getOffsetDateTime(1, '09:00'), endAt:getOffsetDateTime(1, '10:30'), location:'meeting.tuoitre.vn', meetingUrl:'https://meeting.tuoitre.vn/truyen-thong-thang-8', type:'meeting', organizer:'Lê Thanh Vân', responseStatus:'accepted', meetingId:'TT-320-889', platform:'meeting.tuoitre.vn', agenda:'Thống nhất thông điệp, lịch triển khai và đầu mối phối hợp.', participants:['Lê Thanh Vân','Trần Thu Hà','Ngô Mỹ Linh'] },
  { id:'event-05', title:'Làm việc trực tuyến với Ban Khoa giáo', startAt:getOffsetDateTime(1, '14:00'), endAt:getOffsetDateTime(1, '15:00'), location:'meeting.tuoitre.vn', meetingUrl:'https://meeting.tuoitre.vn/khoa-giao', type:'meeting', organizer:'Đỗ Quang Huy', responseStatus:'declined', meetingId:'TT-448-701', platform:'meeting.tuoitre.vn', agenda:'Đối chiếu số liệu chuyên đề giáo dục và chốt tiến độ bàn giao.', participants:['Đỗ Quang Huy','Nguyễn Minh Anh','Phạm Đức Long'] },
  { id:'event-06', title:'Đào tạo an toàn thông tin', startAt:getOffsetDateTime(2, '08:30'), endAt:getOffsetDateTime(2, '11:30'), location:'meeting.tuoitre.vn', meetingUrl:'https://meeting.tuoitre.vn/an-toan-thong-tin', type:'meeting', organizer:'Phòng Công nghệ', responseStatus:'accepted', meetingId:'TT-901-336', platform:'meeting.tuoitre.vn', agenda:'Cập nhật quy định bảo mật và hướng dẫn xử lý sự cố an toàn thông tin.', participants:['Đặng Quốc Bảo','Tạ Minh Châu','Nguyễn Minh Anh'], recordingAvailable:true },
  { id:'event-07', title:'Họp nhóm dự án số hóa', startAt:getOffsetDateTime(3, '15:00'), endAt:getOffsetDateTime(3, '15:45'), location:'meeting.tuoitre.vn', meetingUrl:'https://meeting.tuoitre.vn/du-an-so-hoa', type:'meeting', organizer:'Phòng Công nghệ', responseStatus:'pending', meetingId:'TT-218-563', platform:'meeting.tuoitre.vn', agenda:'Rà soát tiến độ số hóa kho tư liệu và các vướng mắc kỹ thuật.', participants:['Tạ Minh Châu','Mai Phương Thảo','Phan Thùy Dung'] },
  { id:'event-08', title:'Tổng kết công việc tuần', startAt:getOffsetDateTime(-1, '16:00'), endAt:getOffsetDateTime(-1, '17:00'), location:'meeting.tuoitre.vn', meetingUrl:'https://meeting.tuoitre.vn/tong-ket-tuan', type:'meeting', organizer:'Trần Thu Hà', responseStatus:'pending', meetingId:'TT-557-142', platform:'meeting.tuoitre.vn', agenda:'Tổng kết kết quả trong tuần và thống nhất ưu tiên tuần tiếp theo.', participants:['Trần Thu Hà','Nguyễn Minh Anh','Lê Thanh Vân','Đỗ Quang Huy'] },
];
